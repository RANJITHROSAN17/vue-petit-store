...
if (typeof window !== "undefined" && window !== null) {
  firebase = __webpack_require__(/*! firebase */ "firebase");
}
...
var Mem, dexie, is_cache, is_online, is_visible, poll, poll_request, to_tempo;
Mem = __webpack_require__(/*! memory-orm */ "memory-orm");
dexie = null;
...
poll.cache = function (timestr, vuex_id, opt) {
      ...
      var _ref2 = _asyncToGenerator(function* () {
        ...
        get_by_network = (() => {
          var _ref4 = _asyncToGenerator(function* () {
            var pack, wait;
            pack = yield poll._api[name](url, id);
            yield dexie.data.put({
              idx,
              pack
            });
            wait = new Date() - write_at;
...
poll.caches = function (timestr, opts) {
  var cb, key;
...
var $cookie_storage, $local_storage, $session_storage, Cookie, _, m, relative_to, types;
  ...
  sessionStorage: function (id) {
    ...
    return {
      ...
      mounted: function () {
        ...
        if (s != null) {
          val = this[type_id].by_str(s);

          _.set(this, id, val);

          return this.$set(this.$data.$session_storage, id, val);
        }
      },
      watch: {
        ...
        [id]: function (val) {
          var s;
          this.$set(this.$data.$session_storage, id, val);
    ...
    return {
      ...
      mounted: function () {
        ...
        if (s != null) {
          ...
          this.$set(this.$data.$local_storage, id, val);
        }
        ...
        this[handle_id] = ({
          ...
          if (key === id) {
            val = this[type_id].by_str(newValue);

            _.set(this, id, val);

            return this.$set(this.$data.$local_storage, id, val);
          }
        };
    ...
    return {
      ...
      mounted: function () {
        ...
        if (s != null) {
          ...
          return this.$set(this.$data.$cookie_storage, id, val);
        }
      },
      watch: {
        [global_id]: function (val) {
        ...
        [id]: function (val) {
          var s;
          this.$set(this.$data.$cookie_storage, id, val);
...
var _, nine_hour, relative_to, timezone, to_msec, to_sec, to_tempo, to_x;
...
to_x = function (type, sp, nil) {
  return function (u) {
    switch (u != null ? u.constructor : void 0) {
      case null:
      case void 0:
      case sp:
        return nil;
...
to_tempo = function (since, gap = "0s") {
  var last_at, next_at, now_idx, timeout, write_at;
  since = to_msec(since);
  gap = to_msec(gap);
  gap -= nine_hour;
  write_at = new Date() - 0;
...
module.exports = {
  ...
  types: {
    [Number]: {
      to_str: to_x(String, 0 / 0, ""),
      by_str: to_x(Number, "", 0 / 0),
      by_url: to_x(Number, "", 0 / 0)
    },
    [String]: {
...
var _, m, relative_to, routeBase, types;
  ...
  return function (id) {
    ...
    return {
      ...
      beforeRouteUpdate: function (newRoute, oldRoute, next) {
        ...
        return _.set(this, id, s != null ? this[type_id].by_url(s) : this[default_id]);
      },
      watch: {
        [id]: function (newVal) {
          var href, location;
