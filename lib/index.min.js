...
var FancyDate, FastEarth, GREGORIO, MARS_GREGORIO, a, b, g, idx, year, 元号, 六十干支, 十二支, 十干, 地球, 平気法, 火星;
...
FancyDate.平気法 = FancyDate.Gregorian.dup().planet(...地球).calendar(...平気法.calendar).rolls(...平気法.rolls).era("西暦", 元号).yeary(...平気法.yeary).daily(...平気法.daily).init();
FancyDate.Fast = FancyDate.Gregorian.dup().planet(...FastEarth).era("fast", 元号).init();
火星 = [[59354347573.5373, new Date("2018/10/28 09:00").getTime()], [2551442889.6, new Date("2019/01/06 10:28").getTime() // ちょっと困ったので地球の月の値
...
var FancyDate = class FancyDate {
  ...
  init() {
    var a, hour, idx, list, minute, month, msec, season, second, title, u, week, zero;
