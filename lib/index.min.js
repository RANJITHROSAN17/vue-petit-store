...
poll_request = function () {
  ...
  dexie.version(2).stores({
    ...
    return tx.data.toCollection().modify(function (o) {
      o.data = o.pack;
      return delete o.data;
    });
  });
      ...
      var _ref2 = _asyncToGenerator(function* () {
        ...
        get_by_lf = (() => {
          var _ref3 = _asyncToGenerator(function* () {
            ...
            Mem.State.store(meta); // Mem.State.cleanup has_last[idx], meta
            // has_last[idx] = meta
        ...
        get_by_network = (() => {
          var _ref4 = _asyncToGenerator(function* () {
            ...
            meta.idx = idx; // Mem.State.cleanup has_last[idx], meta
            // has_last[idx] = meta
...
var _, relative_to, to_Array, to_Number, to_String;
...
var DAY, DISTANCES, DISTANCE_LONG_AGO, DISTANCE_NAN, HOUR, INTERVAL, MINUTE, MONTH, SECOND, TIMEZONE_OFFSET_JP, VALID, WEEK, YEAR, m, timezone, to_msec, to_relative_time_distance, to_sec, to_tempo, to_tempo_bare;
...
to_tempo = function (since, gap = "0s", write_at = new Date()) {
  since = to_msec(since);
  gap = to_msec(gap);
  gap -= timezone;
  write_at -= 0;
  return to_tempo_bare(since, gap, write_at);
};

to_tempo_bare = function (since, gap, write_at) {
  var last_at, next_at, now_idx, timeout;
