...
var FancyDate, FastEarth, GREGORIO, MARS_GREGORIO, a, b, g, idx, 七曜, 二十四節季, 元号, 六十干支, 六十干支よみ, 六曜, 十二支, 十干, 和風月名, 地球, 平気法, 日本, 時の鐘, 月相, 火星;
...
var FancyDate = class FancyDate {
  ...
  rolls(weeks, etos) {
    ...
    etos = new Indexer(this.dic, '干支', ...etos);
    Object.assign(this.dic, {
      weeks,
      etos
    });
  ...
  init() {
    var D, E, G, H, J, M, N, S, Y, Z, a, at, d, e, f, hour, idx, key, list, m, minute, month, msec, ref, s, season, second, title, u, w, week, y, zero;
  ...
  */
  ...
  to_tempos(utc) {
    ...
    graph = `${this.dic.seasons.at(Z.now_idx)} ${Z.now_idx % 2 ? _.padStart((Z.now_idx + 1) / 2, 2, '0') : "  "}\t ${y.now_idx}年${Nn.is_leap ? "閏" : "  "}${_.padStart(Nn.now_idx + 1, 2, '0')}月${_.padStart(N.now_idx + 1, 2, '0')}日\t`;
    return {
      G,
      u,
      y,
