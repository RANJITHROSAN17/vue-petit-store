...
FancyDate.平気法 = new FancyDate().planet(...地球).calendar(...平気法.calendar).rolls(...平気法.rolls).era("謎暦", 元号).yeary(...平気法.yeary).seasonly(...GREGORIO.seasonly).moony(...GREGORIO.moony).daily(...平気法.daily).init();
...
var FancyDate = class FancyDate {
  ...
  */
  ...
  to_tempos(utc) {
    var D, E, G, H, J, M, N, N0, N0_p, Nn, Nn_p, Np, Np_p, S, T, Z, Zz, after_leap_month, d, drill_down, e, era, era_base, graph, m, now_idx, p, s, to_tempo_mod, u, w, w0, y;
    ...
    if (after_leap_month) {
      ...
      switch (Nn.now_idx) {
        case -1:
          ...
          Zz.last_at -= this.calc.msec.year;
          Zz.next_at -= this.calc.msec.year;
          Zz.now_idx -= 1;
          break;
  ...
  to_label(o, token, length) {
    switch (token) {
      ...
      case 'w':
        return `${_.padStart(o.now_idx + 1, length, '0')}週`;
