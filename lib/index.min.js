...
var FictionalDate = class FictionalDate {
  ...
  def_zero() {
    ...
    week = day + zero_size("week") / this.calc.divs.week; // 単純のため平気法。
  ...
  */
  ...
  to_label({
    ...
    switch (token) {
      ...
      case 'M':
        return `${is_leap ? "閏" : ""}${this.dic.months[now_idx]}`;
...
FictionalDate.平気法 = new FictionalDate().planet(...EARTH).calendar(["", "前"], "1970年1月1日(木)0時0分0秒", 0, null).yeary(["先勝", "友引", "先負", "仏滅", "大安", "赤口"], ['睦月', '如月', '弥生', '卯月', '皐月', '水無月', '文月', '葉月', '長月', '神無月', '霜月', '師走']).seasonly(["立春", "雨水", "啓蟄", "春分", "清明", "穀雨", "立夏", "小満", "芒種", "夏至", "小暑", "大暑", "立秋", "処暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至", "小寒", "大寒"]).moony(['朔', '既朔', '三日月', '上弦', '上弦', '上弦', '上弦', '上弦', '上弦', '上弦', '上弦', '上弦', '十三夜', '小望月', '満月', '十六夜', '立待月', '居待月', '臥待月', '更待月', '下限', '下限', '下限', '下限', '下限', '下限', '下限', '下限', '晦', '晦']).daily(['夜九つ', '夜八つ', '暁七つ', '明六つ', '朝五つ', '昼四つ', '昼九つ', '昼八つ', '夕七つ', '暮六つ', '宵五つ', '夜四つ'], ['一つ', '二つ', '三つ', '四つ']).init();
